...
import stylesCss from 'themes/hycrfiddemos/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_hycrfiddemos_componentCss']) {
    
    document['_vaadintheme_hycrfiddemos_componentCss'] = true;
  }
